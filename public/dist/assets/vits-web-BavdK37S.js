import { _ as __vitePreload } from "../app.js";
...
async function N(e, m) {
  h = h ?? await __vitePreload(() => import("./piper-DeOu3H9E-CDUj5SHU.js"), true ? [] : void 0), _ = _ ?? await __vitePreload(() => import("./ort.min-DTLQmVxY.js"), true ? [] : void 0);
  const n = c[e.voiceId], o = JSON.stringify([{ text: e.text.trim() }]);
  _.env.allowLocalModels = false, _.env.wasm.numThreads = navigator.hardwareConcurrency, _.env.wasm.wasmPaths = B;
...
//# sourceMappingURL=vits-web-BavdK37S.js.map
