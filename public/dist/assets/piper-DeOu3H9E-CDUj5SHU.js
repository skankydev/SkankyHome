      ...
      if (!(o.ENVIRONMENT_IS_PTHREAD || o.$ww)) {
        var e = function(a) {
          ...
          function d(h, g, p, _) {
            ...
            E.open("GET", h, true), E.responseType = "arraybuffer", E.onprogress = function(b) {
              var S = h, f = g;
              if (b.total && (f = b.total), b.loaded) {
                E.addedTotal ? o.dataFileDownloads[S].loaded = b.loaded : (E.addedTotal = true, o.dataFileDownloads || (o.dataFileDownloads = {}), o.dataFileDownloads[S] = { loaded: b.loaded, total: f });
                var c = 0, z = 0, D = 0;
          ...
          function y() {
            ...
            g.prototype = {
              ...
              finish: function(b) {
                var S = this;
                o.FS_createDataFile(this.name, null, b, true, true, true), o.removeRunDependency(`fp ${S.name}`), this.requests[this.name] = null;
              }
            };
...
`));
      ...
      mknod(e, a, t) {
        var r = n.lookupPath(e, { parent: true }), s = r.node, i = P.basename(e);
        if (!i || i === "." || i === "..")
          throw new n.ErrnoError(28);
      ...
      rmdir(e) {
        var a = n.lookupPath(e, { parent: true }), t = a.node, r = P.basename(e), s = n.lookupNode(t, r), i = n.mayDelete(t, r, true);
        if (i)
          throw new n.ErrnoError(i);
        if (!t.node_ops.rmdir)
          throw new n.ErrnoError(63);
      ...
      unlink(e) {
        ...
        if (!t)
          throw new n.ErrnoError(44);
        var r = P.basename(e), s = n.lookupNode(t, r), i = n.mayDelete(t, r, false);
        if (i)
          throw new n.ErrnoError(i);
      ...
      analyzePath(e, a) {
        ...
        try {
          ...
          r.parentExists = true, r.parentPath = t.path, r.parentObject = t.node, r.name = P.basename(e), t = n.lookupPath(e, { follow: !a }), r.exists = true, r.path = t.path, r.object = t.node, r.name = t.node.name, r.isRoot = t.path === "/";
        } catch (s) {
          r.error = s.errno;
        }
        return r;
      ...
      forceLoadFile(e) {
        ...
        if (G)
          try {
            e.contents = le(G(e.url), true), e.usedBytes = e.contents.length;
          } catch {
            throw new n.ErrnoError(29);
          }
        else
      ...
      createLazyFile(e, a, t, r, s) {
        ...
        if (i.prototype.get = function(p) {
          ...
          if (p.open("HEAD", t, false), p.send(null), !(p.status >= 200 && p.status < 300 || p.status === 304))
          ...
          var c = (D, x) => {
            ...
            var R = new XMLHttpRequest();
            if (R.open("GET", t, false), _ !== f && R.setRequestHeader("Range", "bytes=" + D + "-" + x), R.responseType = "arraybuffer", R.overrideMimeType && R.overrideMimeType("text/plain; charset=x-user-defined"), R.send(null), !(R.status >= 200 && R.status < 300 || R.status === 304))
              throw new Error("Couldn't load " + t + ". Status: " + R.status);
            return R.response !== void 0 ? new Uint8Array(R.response || []) : le(R.responseText || "", true);
          }, z = this;
          z.setDataGetter((D) => {
            var x = D * f, R = (D + 1) * f - 1;
            if (R = Math.min(R, _ - 1), typeof z.chunks[D] > "u" && (z.chunks[D] = c(x, R)), typeof z.chunks[D] > "u") throw new Error("doXHR failed!");
            return z.chunks[D];
          }), (S || !_) && (f = _ = 1, _ = this.getter(0).length, f = _, ke("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = _, this._chunkSize = f, this.lengthKnown = true;
        ...
        return v.read = (g, p, _, E, b) => (n.forceLoadFile(m), h(g, p, _, E, b)), v.mmap = (g, p, _, E, b) => {
          ...
          if (!S)
            throw new n.ErrnoError(48);
          return h(g, T, S, p, _), { ptr: S, allocated: true };
        }, m.stream_ops = v, m;
      }
    }, F = {
      DEFAULT_POLLMASK: 5,
      ...
      try {
        ...
        for (var s = 280, i = 0, d = n.llseek(r, 0, 1), l = Math.floor(d / s); l < r.getdents.length && i + s <= t; ) {
          ...
          if (y === ".")
            ...
            var h = n.lookupPath(r.path, { parent: true });
            m = h.node.id, v = 4;
          } else {
...
`,
    ...
    function Ke(e = ge) {
      if (U > 0 || (ta(), U > 0))
        return;
      function a() {
        pe || (pe = true, o.calledRun = true, !he && (na(), ra(), Pe(o), o.onRuntimeInitialized && o.onRuntimeInitialized(), Je && Ve(e), sa()));
      }
    ...
    if (o.preInit)
      for (typeof o.preInit == "function" && (o.preInit = [o.preInit]); o.preInit.length > 0; )
        o.preInit.pop()();
    var Je = false;
    return o.noInitialRun && (Je = false), Ke(), Fe.ready;
  };
})();
export {
  ft as createPiperPhonemize
};
//# sourceMappingURL=piper-DeOu3H9E-CDUj5SHU.js.map
